...
$root.SampleData = (function() {
     ...
     * @instance
     */
    SampleData.prototype.int64Col = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
     ...
     * @instance
     */
    SampleData.prototype.dateCol = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
     ...
     * @instance
     */
    SampleData.prototype.timestampCol = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
     ...
     * @instance
     */
    SampleData.prototype.rowNum = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
    ...
    SampleData.encode = function encode(message, writer) {
        ...
        if (message.boolCol != null && Object.hasOwnProperty.call(message, "boolCol"))
            writer.uint32(/* id 1, wireType 0 =*/8).bool(message.boolCol);
        if (message.bytesCol != null && Object.hasOwnProperty.call(message, "bytesCol"))
            writer.uint32(/* id 2, wireType 2 =*/18).bytes(message.bytesCol);
        if (message.float64Col != null && Object.hasOwnProperty.call(message, "float64Col"))
            writer.uint32(/* id 3, wireType 5 =*/29).float(message.float64Col);
        if (message.int64Col != null && Object.hasOwnProperty.call(message, "int64Col"))
            writer.uint32(/* id 4, wireType 0 =*/32).int64(message.int64Col);
        if (message.stringCol != null && Object.hasOwnProperty.call(message, "stringCol"))
            writer.uint32(/* id 5, wireType 2 =*/42).string(message.stringCol);
        if (message.dateCol != null && Object.hasOwnProperty.call(message, "dateCol"))
            writer.uint32(/* id 6, wireType 0 =*/48).int64(message.dateCol);
        if (message.datetimeCol != null && Object.hasOwnProperty.call(message, "datetimeCol"))
            writer.uint32(/* id 7, wireType 2 =*/58).string(message.datetimeCol);
        if (message.geographyCol != null && Object.hasOwnProperty.call(message, "geographyCol"))
            writer.uint32(/* id 8, wireType 2 =*/66).string(message.geographyCol);
        if (message.numericCol != null && Object.hasOwnProperty.call(message, "numericCol"))
            writer.uint32(/* id 9, wireType 2 =*/74).string(message.numericCol);
        if (message.bignumericCol != null && Object.hasOwnProperty.call(message, "bignumericCol"))
            writer.uint32(/* id 10, wireType 2 =*/82).string(message.bignumericCol);
        if (message.timeCol != null && Object.hasOwnProperty.call(message, "timeCol"))
            writer.uint32(/* id 11, wireType 2 =*/90).string(message.timeCol);
        if (message.timestampCol != null && Object.hasOwnProperty.call(message, "timestampCol"))
        ...
        if (message.structCol != null && Object.hasOwnProperty.call(message, "structCol"))
            $root.SampleData.SampleStruct.encode(message.structCol, writer.uint32(/* id 14, wireType 2 =*/114).fork()).ldelim();
        if (message.structList != null && message.structList.length)
            for (var i = 0; i < message.structList.length; ++i)
                $root.SampleData.SampleStruct.encode(message.structList[i], writer.uint32(/* id 15, wireType 2 =*/122).fork()).ldelim();
    ...
    SampleData.decode = function decode(reader, length) {
        ...
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.SampleData();
            ...
            case 13: {
                    ...
                    if ((tag & 7) === 2) {
                        ...
                        while (reader.pos < end2)
                            message.int64List.push(reader.int64());
                    } else
                        message.int64List.push(reader.int64());
                    break;
                }
            case 14: {
                    message.structCol = $root.SampleData.SampleStruct.decode(reader, reader.uint32());
                    break;
                }
            case 15: {
                    if (!(message.structList && message.structList.length))
                        message.structList = [];
                    message.structList.push($root.SampleData.SampleStruct.decode(reader, reader.uint32()));
                    break;
                }
            case 16: {
        ...
        if (!message.hasOwnProperty("rowNum"))
            throw $util.ProtocolError("missing required 'rowNum'", { instance: message });
        return message;
    };
    ...
    SampleData.verify = function verify(message) {
        ...
        if (message.bytesCol != null && message.hasOwnProperty("bytesCol"))
            if (!(message.bytesCol && typeof message.bytesCol.length === "number" || $util.isString(message.bytesCol)))
        ...
        if (message.int64Col != null && message.hasOwnProperty("int64Col"))
            if (!$util.isInteger(message.int64Col) && !(message.int64Col && $util.isInteger(message.int64Col.low) && $util.isInteger(message.int64Col.high)))
        ...
        if (message.dateCol != null && message.hasOwnProperty("dateCol"))
            if (!$util.isInteger(message.dateCol) && !(message.dateCol && $util.isInteger(message.dateCol.low) && $util.isInteger(message.dateCol.high)))
        ...
        if (message.bignumericCol != null && message.hasOwnProperty("bignumericCol"))
        ...
        if (message.timeCol != null && message.hasOwnProperty("timeCol"))
            if (!$util.isString(message.timeCol))
                return "timeCol: string expected";
        if (message.timestampCol != null && message.hasOwnProperty("timestampCol"))
            if (!$util.isInteger(message.timestampCol) && !(message.timestampCol && $util.isInteger(message.timestampCol.low) && $util.isInteger(message.timestampCol.high)))
                return "timestampCol: integer|Long expected";
        if (message.int64List != null && message.hasOwnProperty("int64List")) {
            if (!Array.isArray(message.int64List))
                return "int64List: array expected";
            for (var i = 0; i < message.int64List.length; ++i)
                if (!$util.isInteger(message.int64List[i]) && !(message.int64List[i] && $util.isInteger(message.int64List[i].low) && $util.isInteger(message.int64List[i].high)))
        ...
        if (message.structList != null && message.hasOwnProperty("structList")) {
            ...
            for (var i = 0; i < message.structList.length; ++i) {
                ...
                if (error)
                    return "structList." + error;
            }
        }
        if (!$util.isInteger(message.rowNum) && !(message.rowNum && $util.isInteger(message.rowNum.low) && $util.isInteger(message.rowNum.high)))
    ...
    SampleData.fromObject = function fromObject(object) {
        if (object instanceof $root.SampleData)
            return object;
        var message = new $root.SampleData();
        if (object.boolCol != null)
            message.boolCol = Boolean(object.boolCol);
        if (object.bytesCol != null)
            if (typeof object.bytesCol === "string")
                $util.base64.decode(object.bytesCol, message.bytesCol = $util.newBuffer($util.base64.length(object.bytesCol)), 0);
            else if (object.bytesCol.length >= 0)
                message.bytesCol = object.bytesCol;
        if (object.float64Col != null)
            message.float64Col = Number(object.float64Col);
        if (object.int64Col != null)
            if ($util.Long)
                (message.int64Col = $util.Long.fromValue(object.int64Col)).unsigned = false;
                ...
                message.int64Col = new $util.LongBits(object.int64Col.low >>> 0, object.int64Col.high >>> 0).toNumber();
        if (object.stringCol != null)
            message.stringCol = String(object.stringCol);
        if (object.dateCol != null)
            if ($util.Long)
                (message.dateCol = $util.Long.fromValue(object.dateCol)).unsigned = false;
                ...
                message.dateCol = new $util.LongBits(object.dateCol.low >>> 0, object.dateCol.high >>> 0).toNumber();
        ...
        if (object.timeCol != null)
            message.timeCol = String(object.timeCol);
        if (object.timestampCol != null)
            if ($util.Long)
                (message.timestampCol = $util.Long.fromValue(object.timestampCol)).unsigned = false;
                ...
                message.timestampCol = new $util.LongBits(object.timestampCol.low >>> 0, object.timestampCol.high >>> 0).toNumber();
        if (object.int64List) {
            ...
            for (var i = 0; i < object.int64List.length; ++i)
                if ($util.Long)
                    (message.int64List[i] = $util.Long.fromValue(object.int64List[i])).unsigned = false;
                    ...
                    message.int64List[i] = new $util.LongBits(object.int64List[i].low >>> 0, object.int64List[i].high >>> 0).toNumber();
        }
        if (object.structCol != null) {
            if (typeof object.structCol !== "object")
                throw TypeError(".SampleData.structCol: object expected");
            message.structCol = $root.SampleData.SampleStruct.fromObject(object.structCol);
        }
        if (object.structList) {
            ...
            for (var i = 0; i < object.structList.length; ++i) {
                ...
                message.structList[i] = $root.SampleData.SampleStruct.fromObject(object.structList[i]);
            }
        }
        if (object.rowNum != null)
            if ($util.Long)
                ...
                message.rowNum = new $util.LongBits(object.rowNum.low >>> 0, object.rowNum.high >>> 0).toNumber();
        return message;
    };
    ...
    SampleData.toObject = function toObject(message, options) {
        ...
        if (options.defaults) {
            ...
            if ($util.Long) {
                ...
                object.int64Col = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
            } else
                object.int64Col = options.longs === String ? "0" : 0;
            object.stringCol = "";
            if ($util.Long) {
                var long = new $util.Long(0, 0, false);
                object.dateCol = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
            } else
                object.dateCol = options.longs === String ? "0" : 0;
            object.datetimeCol = "";
            object.geographyCol = "";
            object.numericCol = "";
            ...
            if ($util.Long) {
                var long = new $util.Long(0, 0, false);
                object.timestampCol = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
            } else
                object.timestampCol = options.longs === String ? "0" : 0;
            object.structCol = null;
            if ($util.Long) {
                var long = new $util.Long(0, 0, false);
                object.rowNum = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
            } else
                object.rowNum = options.longs === String ? "0" : 0;
        }
        if (message.boolCol != null && message.hasOwnProperty("boolCol"))
            object.boolCol = message.boolCol;
        if (message.bytesCol != null && message.hasOwnProperty("bytesCol"))
            object.bytesCol = options.bytes === String ? $util.base64.encode(message.bytesCol, 0, message.bytesCol.length) : options.bytes === Array ? Array.prototype.slice.call(message.bytesCol) : message.bytesCol;
        if (message.float64Col != null && message.hasOwnProperty("float64Col"))
            object.float64Col = options.json && !isFinite(message.float64Col) ? String(message.float64Col) : message.float64Col;
        if (message.int64Col != null && message.hasOwnProperty("int64Col"))
            if (typeof message.int64Col === "number")
                object.int64Col = options.longs === String ? String(message.int64Col) : message.int64Col;
            else
                object.int64Col = options.longs === String ? $util.Long.prototype.toString.call(message.int64Col) : options.longs === Number ? new $util.LongBits(message.int64Col.low >>> 0, message.int64Col.high >>> 0).toNumber() : message.int64Col;
        if (message.stringCol != null && message.hasOwnProperty("stringCol"))
            object.stringCol = message.stringCol;
        if (message.dateCol != null && message.hasOwnProperty("dateCol"))
            if (typeof message.dateCol === "number")
                object.dateCol = options.longs === String ? String(message.dateCol) : message.dateCol;
            else
                object.dateCol = options.longs === String ? $util.Long.prototype.toString.call(message.dateCol) : options.longs === Number ? new $util.LongBits(message.dateCol.low >>> 0, message.dateCol.high >>> 0).toNumber() : message.dateCol;
        if (message.datetimeCol != null && message.hasOwnProperty("datetimeCol"))
        ...
        if (message.timestampCol != null && message.hasOwnProperty("timestampCol"))
            if (typeof message.timestampCol === "number")
                object.timestampCol = options.longs === String ? String(message.timestampCol) : message.timestampCol;
            else
                object.timestampCol = options.longs === String ? $util.Long.prototype.toString.call(message.timestampCol) : options.longs === Number ? new $util.LongBits(message.timestampCol.low >>> 0, message.timestampCol.high >>> 0).toNumber() : message.timestampCol;
        if (message.int64List && message.int64List.length) {
            object.int64List = [];
            for (var j = 0; j < message.int64List.length; ++j)
                if (typeof message.int64List[j] === "number")
                    object.int64List[j] = options.longs === String ? String(message.int64List[j]) : message.int64List[j];
                else
                    object.int64List[j] = options.longs === String ? $util.Long.prototype.toString.call(message.int64List[j]) : options.longs === Number ? new $util.LongBits(message.int64List[j].low >>> 0, message.int64List[j].high >>> 0).toNumber() : message.int64List[j];
        }
        if (message.structCol != null && message.hasOwnProperty("structCol"))
            object.structCol = $root.SampleData.SampleStruct.toObject(message.structCol, options);
        if (message.structList && message.structList.length) {
            object.structList = [];
            for (var j = 0; j < message.structList.length; ++j)
                object.structList[j] = $root.SampleData.SampleStruct.toObject(message.structList[j], options);
        }
        if (message.rowNum != null && message.hasOwnProperty("rowNum"))
            if (typeof message.rowNum === "number")
                object.rowNum = options.longs === String ? String(message.rowNum) : message.rowNum;
            else
                object.rowNum = options.longs === String ? $util.Long.prototype.toString.call(message.rowNum) : options.longs === Number ? new $util.LongBits(message.rowNum.low >>> 0, message.rowNum.high >>> 0).toNumber() : message.rowNum;
        return object;
    };
    ...
    SampleData.SampleStruct = (function() {
         ...
         * @instance
         */
        SampleStruct.prototype.subIntCol = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
        ...
        SampleStruct.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.subIntCol != null && Object.hasOwnProperty.call(message, "subIntCol"))
        ...
        SampleStruct.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.SampleData.SampleStruct();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        SampleStruct.verify = function verify(message) {
            ...
            if (message.subIntCol != null && message.hasOwnProperty("subIntCol"))
                if (!$util.isInteger(message.subIntCol) && !(message.subIntCol && $util.isInteger(message.subIntCol.low) && $util.isInteger(message.subIntCol.high)))
        ...
        SampleStruct.fromObject = function fromObject(object) {
            if (object instanceof $root.SampleData.SampleStruct)
                return object;
            var message = new $root.SampleData.SampleStruct();
            if (object.subIntCol != null)
                if ($util.Long)
                    (message.subIntCol = $util.Long.fromValue(object.subIntCol)).unsigned = false;
                    ...
                    message.subIntCol = new $util.LongBits(object.subIntCol.low >>> 0, object.subIntCol.high >>> 0).toNumber();
            return message;
        };
        ...
        SampleStruct.toObject = function toObject(message, options) {
            ...
            if (options.defaults)
                if ($util.Long) {
                    var long = new $util.Long(0, 0, false);
                    object.subIntCol = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.subIntCol = options.longs === String ? "0" : 0;
            if (message.subIntCol != null && message.hasOwnProperty("subIntCol"))
                if (typeof message.subIntCol === "number")
                    object.subIntCol = options.longs === String ? String(message.subIntCol) : message.subIntCol;
                else
                    object.subIntCol = options.longs === String ? $util.Long.prototype.toString.call(message.subIntCol) : options.longs === Number ? new $util.LongBits(message.subIntCol.low >>> 0, message.subIntCol.high >>> 0).toNumber() : message.subIntCol;
            return object;
        };
