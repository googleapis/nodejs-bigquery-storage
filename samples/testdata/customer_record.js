...
$root.CustomerRecord = (function() {
     ...
     * @instance
     */
    CustomerRecord.prototype.rowNum = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
    ...
    CustomerRecord.decode = function decode(reader, length) {
        ...
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.CustomerRecord();
    ...
    CustomerRecord.fromObject = function fromObject(object) {
        if (object instanceof $root.CustomerRecord)
            return object;
