 ...
 * `src/v1alpha2/big_query_write_client_config.json`.
...
export class BigQueryWriteClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.bigquery.storage.v1alpha2.BigQueryWrite', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.bigQueryWriteStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.bigquery.storage.v1alpha2.BigQueryWrite') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.bigquery.storage.v1alpha2.BigQueryWrite,
  ...
  // -------------------
  createWriteStream(
      request: protos.google.cloud.bigquery.storage.v1alpha2.ICreateWriteStreamRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.bigquery.storage.v1alpha2.IWriteStream,
        protos.google.cloud.bigquery.storage.v1alpha2.ICreateWriteStreamRequest|undefined, {}|undefined
      ]>;
  createWriteStream(
      request: protos.google.cloud.bigquery.storage.v1alpha2.ICreateWriteStreamRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.bigquery.storage.v1alpha2.IWriteStream,
          protos.google.cloud.bigquery.storage.v1alpha2.ICreateWriteStreamRequest|null|undefined,
          {}|null|undefined>): void;
  createWriteStream(
      request: protos.google.cloud.bigquery.storage.v1alpha2.ICreateWriteStreamRequest,
      callback: Callback<
 ...
 */
  ...
  getWriteStream(
      request: protos.google.cloud.bigquery.storage.v1alpha2.IGetWriteStreamRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.bigquery.storage.v1alpha2.IWriteStream,
        protos.google.cloud.bigquery.storage.v1alpha2.IGetWriteStreamRequest|undefined, {}|undefined
      ]>;
  getWriteStream(
      request: protos.google.cloud.bigquery.storage.v1alpha2.IGetWriteStreamRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.bigquery.storage.v1alpha2.IWriteStream,
          protos.google.cloud.bigquery.storage.v1alpha2.IGetWriteStreamRequest|null|undefined,
          {}|null|undefined>): void;
  getWriteStream(
      request: protos.google.cloud.bigquery.storage.v1alpha2.IGetWriteStreamRequest,
      callback: Callback<
 ...
 */
  ...
  finalizeWriteStream(
      request: protos.google.cloud.bigquery.storage.v1alpha2.IFinalizeWriteStreamRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.bigquery.storage.v1alpha2.IFinalizeWriteStreamResponse,
        protos.google.cloud.bigquery.storage.v1alpha2.IFinalizeWriteStreamRequest|undefined, {}|undefined
      ]>;
  finalizeWriteStream(
      request: protos.google.cloud.bigquery.storage.v1alpha2.IFinalizeWriteStreamRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.bigquery.storage.v1alpha2.IFinalizeWriteStreamResponse,
          protos.google.cloud.bigquery.storage.v1alpha2.IFinalizeWriteStreamRequest|null|undefined,
          {}|null|undefined>): void;
  finalizeWriteStream(
      request: protos.google.cloud.bigquery.storage.v1alpha2.IFinalizeWriteStreamRequest,
      callback: Callback<
 ...
 */
  ...
  batchCommitWriteStreams(
      request: protos.google.cloud.bigquery.storage.v1alpha2.IBatchCommitWriteStreamsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.bigquery.storage.v1alpha2.IBatchCommitWriteStreamsResponse,
        protos.google.cloud.bigquery.storage.v1alpha2.IBatchCommitWriteStreamsRequest|undefined, {}|undefined
      ]>;
  batchCommitWriteStreams(
      request: protos.google.cloud.bigquery.storage.v1alpha2.IBatchCommitWriteStreamsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.bigquery.storage.v1alpha2.IBatchCommitWriteStreamsResponse,
          protos.google.cloud.bigquery.storage.v1alpha2.IBatchCommitWriteStreamsRequest|null|undefined,
          {}|null|undefined>): void;
  batchCommitWriteStreams(
      request: protos.google.cloud.bigquery.storage.v1alpha2.IBatchCommitWriteStreamsRequest,
      callback: Callback<
 ...
 */
  ...
  flushRows(
      request: protos.google.cloud.bigquery.storage.v1alpha2.IFlushRowsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.bigquery.storage.v1alpha2.IFlushRowsResponse,
        protos.google.cloud.bigquery.storage.v1alpha2.IFlushRowsRequest|undefined, {}|undefined
      ]>;
  flushRows(
      request: protos.google.cloud.bigquery.storage.v1alpha2.IFlushRowsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.bigquery.storage.v1alpha2.IFlushRowsResponse,
          protos.google.cloud.bigquery.storage.v1alpha2.IFlushRowsRequest|null|undefined,
          {}|null|undefined>): void;
  flushRows(
      request: protos.google.cloud.bigquery.storage.v1alpha2.IFlushRowsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [FlushRowsResponse]{@link google.cloud.bigquery.storage.v1alpha2.FlushRowsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
