...
describe('v1alpha2.BigQueryWriteClient', () => {
    it('has servicePath', () => {
        const servicePath = bigquerywriteModule.v1alpha2.BigQueryWriteClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = bigquerywriteModule.v1alpha2.BigQueryWriteClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = bigquerywriteModule.v1alpha2.BigQueryWriteClient.port;
        assert(port);
    ...
    describe('createWriteStream', () => {
        it('invokes createWriteStream without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.bigquery.storage.v1alpha2.CreateWriteStreamRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.bigquery.storage.v1alpha2.WriteStream());
        ...
        it('invokes createWriteStream without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createWriteStream(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.storage.v1alpha2.IWriteStream|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getWriteStream', () => {
        it('invokes getWriteStream without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.bigquery.storage.v1alpha2.GetWriteStreamRequest());
            request.name = '';
    ...
    describe('finalizeWriteStream', () => {
        it('invokes finalizeWriteStream without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.bigquery.storage.v1alpha2.FinalizeWriteStreamRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.bigquery.storage.v1alpha2.FinalizeWriteStreamResponse());
        ...
        it('invokes finalizeWriteStream without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.finalizeWriteStream(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.storage.v1alpha2.IFinalizeWriteStreamResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('batchCommitWriteStreams', () => {
        it('invokes batchCommitWriteStreams without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.bigquery.storage.v1alpha2.BatchCommitWriteStreamsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.bigquery.storage.v1alpha2.BatchCommitWriteStreamsResponse());
        ...
        it('invokes batchCommitWriteStreams without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchCommitWriteStreams(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.storage.v1alpha2.IBatchCommitWriteStreamsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('flushRows', () => {
        it('invokes flushRows without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.bigquery.storage.v1alpha2.FlushRowsRequest());
            request.writeStream = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.bigquery.storage.v1alpha2.FlushRowsResponse());
        ...
        it('invokes flushRows without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.flushRows(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.storage.v1alpha2.IFlushRowsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('appendRows', () => {
        it('invokes appendRows without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.bigquery.storage.v1alpha2.AppendRowsRequest());
            const expectedResponse = generateSampleMessage(new protos.google.cloud.bigquery.storage.v1alpha2.AppendRowsResponse());
            client.innerApiCalls.appendRows = stubBidiStreamingCall(expectedResponse);
            const stream = client.appendRows();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.bigquery.storage.v1alpha2.AppendRowsResponse) => {
                    resolve(response);
                });
