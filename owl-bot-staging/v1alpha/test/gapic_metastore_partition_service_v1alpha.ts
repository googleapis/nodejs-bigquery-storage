...
describe('v1alpha.MetastorePartitionServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new metastorepartitionserviceModule.v1alpha.MetastorePartitionServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = metastorepartitionserviceModule.v1alpha.MetastorePartitionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = metastorepartitionserviceModule.v1alpha.MetastorePartitionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'bigquerystorage.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new metastorepartitionserviceModule.v1alpha.MetastorePartitionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'bigquerystorage.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new metastorepartitionserviceModule.v1alpha.MetastorePartitionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'bigquerystorage.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new metastorepartitionserviceModule.v1alpha.MetastorePartitionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new metastorepartitionserviceModule.v1alpha.MetastorePartitionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = metastorepartitionserviceModule.v1alpha.MetastorePartitionServiceClient.port;
            assert(port);
    ...
    describe('batchCreateMetastorePartitions', () => {
        it('invokes batchCreateMetastorePartitions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.storage.v1alpha.BatchCreateMetastorePartitionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.bigquery.storage.v1alpha.BatchCreateMetastorePartitionsResponse()
            );
            client.innerApiCalls.batchCreateMetastorePartitions = stubSimpleCall(expectedResponse);
            const [response] = await client.batchCreateMetastorePartitions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchCreateMetastorePartitions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchCreateMetastorePartitions as SinonStub)
        ...
        it('invokes batchCreateMetastorePartitions without error using callback', async () => {
            ...
            client.innerApiCalls.batchCreateMetastorePartitions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateMetastorePartitions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.storage.v1alpha.IBatchCreateMetastorePartitionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchCreateMetastorePartitions with error', async () => {
            ...
            client.innerApiCalls.batchCreateMetastorePartitions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchCreateMetastorePartitions(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchCreateMetastorePartitions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchCreateMetastorePartitions as SinonStub)
    ...
    describe('batchDeleteMetastorePartitions', () => {
        it('invokes batchDeleteMetastorePartitions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.storage.v1alpha.BatchDeleteMetastorePartitionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.batchDeleteMetastorePartitions = stubSimpleCall(expectedResponse);
            const [response] = await client.batchDeleteMetastorePartitions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchDeleteMetastorePartitions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchDeleteMetastorePartitions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchDeleteMetastorePartitions without error using callback', async () => {
            ...
            client.innerApiCalls.batchDeleteMetastorePartitions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes batchDeleteMetastorePartitions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchDeleteMetastorePartitions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchDeleteMetastorePartitions(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchDeleteMetastorePartitions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchDeleteMetastorePartitions as SinonStub)
    ...
    describe('batchUpdateMetastorePartitions', () => {
        it('invokes batchUpdateMetastorePartitions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.storage.v1alpha.BatchUpdateMetastorePartitionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.bigquery.storage.v1alpha.BatchUpdateMetastorePartitionsResponse()
            );
            client.innerApiCalls.batchUpdateMetastorePartitions = stubSimpleCall(expectedResponse);
            const [response] = await client.batchUpdateMetastorePartitions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchUpdateMetastorePartitions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateMetastorePartitions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchUpdateMetastorePartitions without error using callback', async () => {
            ...
            client.innerApiCalls.batchUpdateMetastorePartitions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchUpdateMetastorePartitions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.storage.v1alpha.IBatchUpdateMetastorePartitionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchUpdateMetastorePartitions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchUpdateMetastorePartitions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchUpdateMetastorePartitions(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchUpdateMetastorePartitions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateMetastorePartitions as SinonStub)
    ...
    describe('listMetastorePartitions', () => {
        it('invokes listMetastorePartitions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.storage.v1alpha.ListMetastorePartitionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.bigquery.storage.v1alpha.ListMetastorePartitionsResponse()
            );
            client.innerApiCalls.listMetastorePartitions = stubSimpleCall(expectedResponse);
            const [response] = await client.listMetastorePartitions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listMetastorePartitions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMetastorePartitions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listMetastorePartitions without error using callback', async () => {
            ...
            client.innerApiCalls.listMetastorePartitions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listMetastorePartitions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.storage.v1alpha.IListMetastorePartitionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listMetastorePartitions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listMetastorePartitions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listMetastorePartitions(request), expectedError);
            const actualRequest = (client.innerApiCalls.listMetastorePartitions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMetastorePartitions as SinonStub)
    ...
    describe('streamMetastorePartitions', () => {
        it('invokes streamMetastorePartitions without error', async () => {
            ...
            client.innerApiCalls.streamMetastorePartitions = stubBidiStreamingCall(expectedResponse);
            const stream = client.streamMetastorePartitions();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.bigquery.storage.v1alpha.StreamMetastorePartitionsResponse) => {
                    resolve(response);
                });
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.streamMetastorePartitions as SinonStub)
        ...
        it('invokes streamMetastorePartitions with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.streamMetastorePartitions = stubBidiStreamingCall(undefined, expectedError);
            const stream = client.streamMetastorePartitions();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.bigquery.storage.v1alpha.StreamMetastorePartitionsResponse) => {
                    resolve(response);
