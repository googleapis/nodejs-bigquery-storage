...
export class MetastorePartitionServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof MetastorePartitionServiceClient;
    ...
    this.descriptors.stream = {
      streamMetastorePartitions: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.BIDI_STREAMING, !!opts.fallback, !!opts.gaxServerStreamingRetries)
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.bigquery.storage.v1beta.MetastorePartitionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.metastorePartitionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.bigquery.storage.v1beta.MetastorePartitionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.bigquery.storage.v1beta.MetastorePartitionService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const metastorePartitionServiceStubMethods =
        ['batchCreateMetastorePartitions', 'batchDeleteMetastorePartitions', 'batchUpdateMetastorePartitions', 'listMetastorePartitions', 'streamMetastorePartitions'];
 ...
 */
  batchCreateMetastorePartitions(
      ...
      Promise<[
        ...
        protos.google.cloud.bigquery.storage.v1beta.IBatchCreateMetastorePartitionsRequest|undefined, {}|undefined
      ]>;
  batchCreateMetastorePartitions(
      request: protos.google.cloud.bigquery.storage.v1beta.IBatchCreateMetastorePartitionsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.bigquery.storage.v1beta.IBatchCreateMetastorePartitionsResponse,
          protos.google.cloud.bigquery.storage.v1beta.IBatchCreateMetastorePartitionsRequest|null|undefined,
          {}|null|undefined>): void;
  batchCreateMetastorePartitions(
      request: protos.google.cloud.bigquery.storage.v1beta.IBatchCreateMetastorePartitionsRequest,
      callback: Callback<
  ...
  batchCreateMetastorePartitions(
    ...
    const wrappedCallback: Callback<
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('batchCreateMetastorePartitions response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchCreateMetastorePartitions(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.bigquery.storage.v1beta.IBatchCreateMetastorePartitionsResponse,
        protos.google.cloud.bigquery.storage.v1beta.IBatchCreateMetastorePartitionsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchCreateMetastorePartitions response %j', response);
 ...
 */
  batchDeleteMetastorePartitions(
      ...
      Promise<[
        ...
        protos.google.cloud.bigquery.storage.v1beta.IBatchDeleteMetastorePartitionsRequest|undefined, {}|undefined
      ]>;
  batchDeleteMetastorePartitions(
      request: protos.google.cloud.bigquery.storage.v1beta.IBatchDeleteMetastorePartitionsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.cloud.bigquery.storage.v1beta.IBatchDeleteMetastorePartitionsRequest|null|undefined,
          {}|null|undefined>): void;
  batchDeleteMetastorePartitions(
      request: protos.google.cloud.bigquery.storage.v1beta.IBatchDeleteMetastorePartitionsRequest,
      callback: Callback<
  ...
  batchDeleteMetastorePartitions(
    ...
    const wrappedCallback: Callback<
        ...
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchDeleteMetastorePartitions response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchDeleteMetastorePartitions(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
        protos.google.cloud.bigquery.storage.v1beta.IBatchDeleteMetastorePartitionsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchDeleteMetastorePartitions response %j', response);
        return [response, options, rawResponse];
 ...
 */
  batchUpdateMetastorePartitions(
      ...
      Promise<[
        ...
        protos.google.cloud.bigquery.storage.v1beta.IBatchUpdateMetastorePartitionsRequest|undefined, {}|undefined
      ]>;
  batchUpdateMetastorePartitions(
      request: protos.google.cloud.bigquery.storage.v1beta.IBatchUpdateMetastorePartitionsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.bigquery.storage.v1beta.IBatchUpdateMetastorePartitionsResponse,
          protos.google.cloud.bigquery.storage.v1beta.IBatchUpdateMetastorePartitionsRequest|null|undefined,
          {}|null|undefined>): void;
  batchUpdateMetastorePartitions(
      request: protos.google.cloud.bigquery.storage.v1beta.IBatchUpdateMetastorePartitionsRequest,
      callback: Callback<
  ...
  batchUpdateMetastorePartitions(
    ...
    const wrappedCallback: Callback<
        ...
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchUpdateMetastorePartitions response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchUpdateMetastorePartitions(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.bigquery.storage.v1beta.IBatchUpdateMetastorePartitionsResponse,
        protos.google.cloud.bigquery.storage.v1beta.IBatchUpdateMetastorePartitionsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchUpdateMetastorePartitions response %j', response);
        return [response, options, rawResponse];
 ...
 */
  listMetastorePartitions(
      ...
      Promise<[
        ...
        protos.google.cloud.bigquery.storage.v1beta.IListMetastorePartitionsRequest|undefined, {}|undefined
      ]>;
  listMetastorePartitions(
      request: protos.google.cloud.bigquery.storage.v1beta.IListMetastorePartitionsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.bigquery.storage.v1beta.IListMetastorePartitionsResponse,
          protos.google.cloud.bigquery.storage.v1beta.IListMetastorePartitionsRequest|null|undefined,
          {}|null|undefined>): void;
  listMetastorePartitions(
      request: protos.google.cloud.bigquery.storage.v1beta.IListMetastorePartitionsRequest,
      callback: Callback<
  ...
  listMetastorePartitions(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.listMetastorePartitions(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.bigquery.storage.v1beta.IListMetastorePartitionsResponse,
        protos.google.cloud.bigquery.storage.v1beta.IListMetastorePartitionsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('listMetastorePartitions response %j', response);
        return [response, options, rawResponse];
