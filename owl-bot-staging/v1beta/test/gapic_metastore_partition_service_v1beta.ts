...
describe('v1beta.MetastorePartitionServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new metastorepartitionserviceModule.v1beta.MetastorePartitionServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = metastorepartitionserviceModule.v1beta.MetastorePartitionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = metastorepartitionserviceModule.v1beta.MetastorePartitionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'bigquerystorage.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new metastorepartitionserviceModule.v1beta.MetastorePartitionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'bigquerystorage.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new metastorepartitionserviceModule.v1beta.MetastorePartitionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'bigquerystorage.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new metastorepartitionserviceModule.v1beta.MetastorePartitionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new metastorepartitionserviceModule.v1beta.MetastorePartitionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = metastorepartitionserviceModule.v1beta.MetastorePartitionServiceClient.port;
            assert(port);
    ...
    describe('batchCreateMetastorePartitions', () => {
        it('invokes batchCreateMetastorePartitions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.storage.v1beta.BatchCreateMetastorePartitionsRequest', ['parent']);
        ...
        it('invokes batchCreateMetastorePartitions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateMetastorePartitions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.storage.v1beta.IBatchCreateMetastorePartitionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('batchDeleteMetastorePartitions', () => {
        it('invokes batchDeleteMetastorePartitions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.storage.v1beta.BatchDeleteMetastorePartitionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('batchUpdateMetastorePartitions', () => {
        it('invokes batchUpdateMetastorePartitions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.storage.v1beta.BatchUpdateMetastorePartitionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes batchUpdateMetastorePartitions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchUpdateMetastorePartitions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.storage.v1beta.IBatchUpdateMetastorePartitionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listMetastorePartitions', () => {
        it('invokes listMetastorePartitions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.storage.v1beta.ListMetastorePartitionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes listMetastorePartitions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listMetastorePartitions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.storage.v1beta.IListMetastorePartitionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('streamMetastorePartitions', () => {
        it('invokes streamMetastorePartitions without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.bigquery.storage.v1beta.StreamMetastorePartitionsResponse) => {
                    resolve(response);
                });
