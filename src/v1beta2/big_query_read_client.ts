...
export class BigQueryReadClient {
  ...
  // -------------------
  createReadSession(
    request: protosTypes.google.cloud.bigquery.storage.v1beta2.ICreateReadSessionRequest,
    options?: gax.CallOptions
  ): Promise<
    [
      protosTypes.google.cloud.bigquery.storage.v1beta2.IReadSession,
      (
        | protosTypes.google.cloud.bigquery.storage.v1beta2.ICreateReadSessionRequest
        | undefined
      ),
      {} | undefined
    ]
  ...
  splitReadStream(
    request: protosTypes.google.cloud.bigquery.storage.v1beta2.ISplitReadStreamRequest,
    options?: gax.CallOptions
  ): Promise<
    [
      protosTypes.google.cloud.bigquery.storage.v1beta2.ISplitReadStreamResponse,
      (
        | protosTypes.google.cloud.bigquery.storage.v1beta2.ISplitReadStreamRequest
        | undefined
      ),
      {} | undefined
    ]
   ...
   */
  readRows(
    request?: protosTypes.google.cloud.bigquery.storage.v1beta2.IReadRowsRequest,
    options?: gax.CallOptions
